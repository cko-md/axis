...
- **State fingerprint:** `60a91d8213ba5f6c6a4cecfbf16190aed3179fcd1cb86a877ea404520f37b022` (committed tree plus bound provenance/gate evidence; only the two generated state artifacts are excluded)
...
- **Branch:** `codex/redesign-01-production-sentry-state-refresh`
- **HEAD:** `b8a22fa6`
- **main:** `b8a22fa6`
- **Working tree:** clean
