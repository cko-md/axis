...
- `main` is current (`0367848`): Phases 0–4 complete, 5 substantial, 6 theme/Debrief fixes, 8 PROD+AI-1/2/3/4. Live migrations this session: `calendar_event_cache`, `key_result_progress`; `profiles_bio` backfilled as tracked-only (already in prod).
