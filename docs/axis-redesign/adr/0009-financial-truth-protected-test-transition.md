...
|---|---|---|
| `scripts/release-migration-manifest.json` | `7d554c50a0912b62ce06d402903e91f8fa951c8d` | `7590de247df8dc2bca15fb2f86dafcce5fe4f80767d2e380c13dcf052059d8f8` |
...
The manifest declares 98 migrations and binds `20260809260000` as the exact
...
Cursor advancement occurs only after a claimed item completes; failed,
deadline-interrupted, or crashed work remains reclaimable after token-bound
release or lease expiry. The prior cursor-only service RPC overloads are not
executable after the final contract.
...
candidate SHA, eight base/candidate blob pairs, both final contract migrations,
the 98-entry manifest, and this ADR before running any
...
direct deletion denial and zero-remnant unexecuted-account cleanup, one
