...
export const OPTIONAL_PROVIDER_ENV = {
  ...
  spotify: ["SPOTIFY_CLIENT_ID", "SPOTIFY_CLIENT_SECRET", "DIRECT_PROVIDER_COOKIE_SECRET"],
  strava: ["STRAVA_CLIENT_ID", "STRAVA_CLIENT_SECRET", "DIRECT_PROVIDER_COOKIE_SECRET"],
...
export const OPTIONAL_ENV_NAMES = [
  ...
  "SPOTIFY_CLIENT_SECRET_PREVIOUS",
  "STRAVA_CLIENT_ID",
  "STRAVA_CLIENT_SECRET",
  "STRAVA_CLIENT_SECRET_PREVIOUS",
  "DIRECT_PROVIDER_COOKIE_SECRET",
  "DIRECT_PROVIDER_COOKIE_SECRET_PREVIOUS",
  "DIRECT_PROVIDER_COOKIE_V1_ACCEPT_UNTIL",
  "ANTHROPIC_API_KEY",
  "GEMINI_API_KEY",
