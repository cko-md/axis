...
export const DEFAULT_NAV: NavGroup[] = [
  ...
  { section: "Labs", items: [
    ...
    { href: "/envoys", label: "Envoys", icon: "envoys", title: "Envoy Lab — identity picker and truthful active-work HUD", status: "lab", statusReason: "Starter Envoys are candidate identities without generated art; the HUD projects real task/run/approval records with explicit per-section degradation.", statusAction: "Ship validated hatch-pet packages (Wave 15.5) and prove Mascot parity before promotion." },
